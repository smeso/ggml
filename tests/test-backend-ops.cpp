    ...
    for (int64_t s0 = 1; s0 < 4; ++s0) {
        for (int64_t p0 = 0; p0 < 2; ++p0) {
            for (int64_t d0 = 1; d0 < 4; ++d0) {
                test_cases.emplace_back(new test_conv_transpose_1d({3,2,1,1}, {2,3,2,1}, s0, p0, d0));
                test_cases.emplace_back(new test_conv_transpose_1d({3,2,1,1}, {3,2,2,1}, s0, p0, d0));
                test_cases.emplace_back(new test_conv_transpose_1d({3,2,1,1}, {3,1,2,1}, s0, p0, d0));
                test_cases.emplace_back(new test_conv_transpose_1d({2,1,1,1}, {3,1,1,1}, s0, p0, d0));
                test_cases.emplace_back(new test_conv_transpose_1d({3,2,1,1}, {2,3,2,1},
                                                                   s0, p0, d0, GGML_TYPE_F16));
                test_cases.emplace_back(new test_conv_transpose_1d({3,2,1,1}, {3,2,2,1},
                                                                   s0, p0, d0, GGML_TYPE_F16));
                test_cases.emplace_back(new test_conv_transpose_1d({3,2,1,1}, {3,1,2,1},
                                                                   s0, p0, d0, GGML_TYPE_F16));
                test_cases.emplace_back(new test_conv_transpose_1d({2,1,1,1}, {3,1,1,1},
                                                                   s0, p0, d0, GGML_TYPE_F16));
            }
        }
    }
